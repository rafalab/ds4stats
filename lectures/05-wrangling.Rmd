...
```{r, eval=FALSE}
dat %>% separate(key, c("year", "variable"), "_")
```
...
## Example 
```{r}
dat %>% separate(key, c("year", "first_variable",
                        "second_variable"), 
                 fill = "right")
```
...
dat %>% 
  separate(key, 
           c("year", "first_variable", "second_variable"), 
           fill = "right")
```
...
dat %>% 
  separate(key, 
           c("year", "first_variable", "second_variable"), 
           fill = "right") %>%
  unite(variable, first_variable, second_variable, sep="_") %>%
  spread(variable, value) %>%
